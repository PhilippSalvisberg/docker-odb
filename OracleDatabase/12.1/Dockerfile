FROM phsalvisberg/odb:12.1sw

LABEL maintainer="philipp.salvisberg@gmail.com"
LABEL description="Oracle Database Enterprise Edition 12.1"
LABEL build.command="docker build . --tag phsalvisberg/odb:12.1"
LABEL run.command="docker run -v odb:/u02 -it -p 8080-8081:8080-8081 -p 1521:1521 -h odb --name odb phsalvisberg/odb:12.1"
